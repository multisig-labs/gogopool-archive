...
//
// Solidity: function getMinipool(int256 index) view returns((address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,address,bytes32) mp)
...
//
// Solidity: function getMinipools(uint8 status, uint256 offset, uint256 limit) view returns((address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,address,bytes32)[] minipools)
...
// RecordStakingError is a paid mutator transaction binding the contract method 0x62b0c29f.
//
// Solidity: function recordStakingError(address nodeID, string message) returns()
func (_MinipoolManager *MinipoolManagerTransactor) RecordStakingError(opts *bind.TransactOpts, nodeID common.Address, message string) (*types.Transaction, error) {
	return _MinipoolManager.contract.Transact(opts, "recordStakingError", nodeID, message)
}

// RecordStakingError is a paid mutator transaction binding the contract method 0x62b0c29f.
//
// Solidity: function recordStakingError(address nodeID, string message) returns()
func (_MinipoolManager *MinipoolManagerSession) RecordStakingError(nodeID common.Address, message string) (*types.Transaction, error) {
	return _MinipoolManager.Contract.RecordStakingError(&_MinipoolManager.TransactOpts, nodeID, message)
}

// RecordStakingError is a paid mutator transaction binding the contract method 0x62b0c29f.
//
// Solidity: function recordStakingError(address nodeID, string message) returns()
func (_MinipoolManager *MinipoolManagerTransactorSession) RecordStakingError(nodeID common.Address, message string) (*types.Transaction, error) {
	return _MinipoolManager.Contract.RecordStakingError(&_MinipoolManager.TransactOpts, nodeID, message)
}
