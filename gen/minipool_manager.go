...
//
// Solidity: function getMinipoolByNodeID(address nodeID) view returns((int256,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,address,address,bytes32) mp)
