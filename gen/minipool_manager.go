...
type MinipoolManagerMinipool struct {
	...
	AvaxNodeOpInitialAmt      *big.Int
	AvaxLiquidStakerAmt       *big.Int
	TxID                      [32]byte
	InitialStartTime          *big.Int
	StartTime                 *big.Int
	EndTime                   *big.Int
...
//
// Solidity: function getMinipool(int256 index) view returns((int256,address,uint256,uint256,uint256,address,address,uint256,uint256,uint256,bytes32,uint256,uint256,uint256,uint256,bytes32,uint256,uint256,uint256) mp)
...
// GetMinipoolByNodeID is a free data retrieval call binding the contract method 0xa715c8b6.
//
// Solidity: function getMinipoolByNodeID(address nodeID) view returns((int256,address,uint256,uint256,uint256,address,address,uint256,uint256,uint256,bytes32,uint256,uint256,uint256,uint256,bytes32,uint256,uint256,uint256) mp)
func (_MinipoolManager *MinipoolManagerCaller) GetMinipoolByNodeID(opts *bind.CallOpts, nodeID common.Address) (MinipoolManagerMinipool, error) {
	var out []interface{}
	err := _MinipoolManager.contract.Call(opts, &out, "getMinipoolByNodeID", nodeID)
...
//
// Solidity: function getMinipoolByNodeID(address nodeID) view returns((int256,address,uint256,uint256,uint256,address,address,uint256,uint256,uint256,bytes32,uint256,uint256,uint256,uint256,bytes32,uint256,uint256,uint256) mp)
func (_MinipoolManager *MinipoolManagerSession) GetMinipoolByNodeID(nodeID common.Address) (MinipoolManagerMinipool, error) {
	return _MinipoolManager.Contract.GetMinipoolByNodeID(&_MinipoolManager.CallOpts, nodeID)
}

// GetMinipoolByNodeID is a free data retrieval call binding the contract method 0xa715c8b6.
//
// Solidity: function getMinipoolByNodeID(address nodeID) view returns((int256,address,uint256,uint256,uint256,address,address,uint256,uint256,uint256,bytes32,uint256,uint256,uint256,uint256,bytes32,uint256,uint256,uint256) mp)
func (_MinipoolManager *MinipoolManagerCallerSession) GetMinipoolByNodeID(nodeID common.Address) (MinipoolManagerMinipool, error) {
	return _MinipoolManager.Contract.GetMinipoolByNodeID(&_MinipoolManager.CallOpts, nodeID)
}
...
//
// Solidity: function getMinipools(uint8 status, uint256 offset, uint256 limit) view returns((int256,address,uint256,uint256,uint256,address,address,uint256,uint256,uint256,bytes32,uint256,uint256,uint256,uint256,bytes32,uint256,uint256,uint256)[] minipools)
...
// FinishFailedMinipoolByMultisig is a paid mutator transaction binding the contract method 0xbe9b84b1.
//
// Solidity: function finishFailedMinipoolByMultisig(address nodeID) returns()
func (_MinipoolManager *MinipoolManagerTransactor) FinishFailedMinipoolByMultisig(opts *bind.TransactOpts, nodeID common.Address) (*types.Transaction, error) {
	return _MinipoolManager.contract.Transact(opts, "finishFailedMinipoolByMultisig", nodeID)
}

// FinishFailedMinipoolByMultisig is a paid mutator transaction binding the contract method 0xbe9b84b1.
//
// Solidity: function finishFailedMinipoolByMultisig(address nodeID) returns()
func (_MinipoolManager *MinipoolManagerSession) FinishFailedMinipoolByMultisig(nodeID common.Address) (*types.Transaction, error) {
	return _MinipoolManager.Contract.FinishFailedMinipoolByMultisig(&_MinipoolManager.TransactOpts, nodeID)
}

// FinishFailedMinipoolByMultisig is a paid mutator transaction binding the contract method 0xbe9b84b1.
//
// Solidity: function finishFailedMinipoolByMultisig(address nodeID) returns()
func (_MinipoolManager *MinipoolManagerTransactorSession) FinishFailedMinipoolByMultisig(nodeID common.Address) (*types.Transaction, error) {
	return _MinipoolManager.Contract.FinishFailedMinipoolByMultisig(&_MinipoolManager.TransactOpts, nodeID)
}
...
// RecordStakingEndThenCycleThenClaim is a paid mutator transaction binding the contract method 0xe80087cb.
//
// Solidity: function recordStakingEndThenCycleThenClaim(address nodeID, uint256 endTime, uint256 avaxTotalRewardAmt) payable returns()
func (_MinipoolManager *MinipoolManagerTransactor) RecordStakingEndThenCycleThenClaim(opts *bind.TransactOpts, nodeID common.Address, endTime *big.Int, avaxTotalRewardAmt *big.Int) (*types.Transaction, error) {
	return _MinipoolManager.contract.Transact(opts, "recordStakingEndThenCycleThenClaim", nodeID, endTime, avaxTotalRewardAmt)
}

// RecordStakingEndThenCycleThenClaim is a paid mutator transaction binding the contract method 0xe80087cb.
//
// Solidity: function recordStakingEndThenCycleThenClaim(address nodeID, uint256 endTime, uint256 avaxTotalRewardAmt) payable returns()
func (_MinipoolManager *MinipoolManagerSession) RecordStakingEndThenCycleThenClaim(nodeID common.Address, endTime *big.Int, avaxTotalRewardAmt *big.Int) (*types.Transaction, error) {
	return _MinipoolManager.Contract.RecordStakingEndThenCycleThenClaim(&_MinipoolManager.TransactOpts, nodeID, endTime, avaxTotalRewardAmt)
}

// RecordStakingEndThenCycleThenClaim is a paid mutator transaction binding the contract method 0xe80087cb.
//
// Solidity: function recordStakingEndThenCycleThenClaim(address nodeID, uint256 endTime, uint256 avaxTotalRewardAmt) payable returns()
func (_MinipoolManager *MinipoolManagerTransactorSession) RecordStakingEndThenCycleThenClaim(nodeID common.Address, endTime *big.Int, avaxTotalRewardAmt *big.Int) (*types.Transaction, error) {
	return _MinipoolManager.Contract.RecordStakingEndThenCycleThenClaim(&_MinipoolManager.TransactOpts, nodeID, endTime, avaxTotalRewardAmt)
}
...
// RecreateMinipool is a paid mutator transaction binding the contract method 0x21478f3e.
//
// Solidity: function recreateMinipool(address nodeID) returns()
func (_MinipoolManager *MinipoolManagerTransactor) RecreateMinipool(opts *bind.TransactOpts, nodeID common.Address) (*types.Transaction, error) {
	return _MinipoolManager.contract.Transact(opts, "recreateMinipool", nodeID)
}

// RecreateMinipool is a paid mutator transaction binding the contract method 0x21478f3e.
//
// Solidity: function recreateMinipool(address nodeID) returns()
func (_MinipoolManager *MinipoolManagerSession) RecreateMinipool(nodeID common.Address) (*types.Transaction, error) {
	return _MinipoolManager.Contract.RecreateMinipool(&_MinipoolManager.TransactOpts, nodeID)
}

// RecreateMinipool is a paid mutator transaction binding the contract method 0x21478f3e.
//
// Solidity: function recreateMinipool(address nodeID) returns()
func (_MinipoolManager *MinipoolManagerTransactorSession) RecreateMinipool(nodeID common.Address) (*types.Transaction, error) {
	return _MinipoolManager.Contract.RecreateMinipool(&_MinipoolManager.TransactOpts, nodeID)
}
