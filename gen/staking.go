...
func (_Staking *StakingCaller) GetPublicContractAddress(opts *bind.CallOpts, _contractName string) (common.Address, error) {
	var out []interface{}
	err := _Staking.contract.Call(opts, &out, "getPublicContractAddress", _contractName)
...
//
// Solidity: function getPublicContractAddress(string _contractName) view returns(address)
func (_Staking *StakingSession) GetPublicContractAddress(_contractName string) (common.Address, error) {
	return _Staking.Contract.GetPublicContractAddress(&_Staking.CallOpts, _contractName)
}

// GetPublicContractAddress is a free data retrieval call binding the contract method 0xcff0b648.
//
// Solidity: function getPublicContractAddress(string _contractName) view returns(address)
func (_Staking *StakingCallerSession) GetPublicContractAddress(_contractName string) (common.Address, error) {
	return _Staking.Contract.GetPublicContractAddress(&_Staking.CallOpts, _contractName)
}
...
// MaxCollateralizationPercent is a free data retrieval call binding the contract method 0xfb1ae26d.
//
// Solidity: function maxCollateralizationPercent() view returns(uint256)
func (_Staking *StakingCaller) MaxCollateralizationPercent(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Staking.contract.Call(opts, &out, "maxCollateralizationPercent")
...
// MinCollateralizationPercent is a free data retrieval call binding the contract method 0xf84a4e6e.
//
// Solidity: function minCollateralizationPercent() view returns(uint256)
func (_Staking *StakingCaller) MinCollateralizationPercent(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Staking.contract.Call(opts, &out, "minCollateralizationPercent")
