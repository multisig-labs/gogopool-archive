...
// GetLastRewardsCycleCompleted is a free data retrieval call binding the contract method 0x65538c0f.
//
// Solidity: function getLastRewardsCycleCompleted(address stakerAddr) view returns(uint256)
func (_Staking *StakingCaller) GetLastRewardsCycleCompleted(opts *bind.CallOpts, stakerAddr common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Staking.contract.Call(opts, &out, "getLastRewardsCycleCompleted", stakerAddr)
...
//
// Solidity: function getLastRewardsCycleCompleted(address stakerAddr) view returns(uint256)
func (_Staking *StakingSession) GetLastRewardsCycleCompleted(stakerAddr common.Address) (*big.Int, error) {
	return _Staking.Contract.GetLastRewardsCycleCompleted(&_Staking.CallOpts, stakerAddr)
}

// GetLastRewardsCycleCompleted is a free data retrieval call binding the contract method 0x65538c0f.
//
// Solidity: function getLastRewardsCycleCompleted(address stakerAddr) view returns(uint256)
func (_Staking *StakingCallerSession) GetLastRewardsCycleCompleted(stakerAddr common.Address) (*big.Int, error) {
	return _Staking.Contract.GetLastRewardsCycleCompleted(&_Staking.CallOpts, stakerAddr)
}
...
//
// Solidity: function getStaker(int256 stakerIndex) view returns((address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256) staker)
...
//
// Solidity: function getStakers(uint256 offset, uint256 limit) view returns((address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)[] stakers)
...
// IncreaseAVAXAssignedHighWater is a paid mutator transaction binding the contract method 0xe4200b60.
//
// Solidity: function increaseAVAXAssignedHighWater(address stakerAddr, uint256 amount) returns()
func (_Staking *StakingTransactor) IncreaseAVAXAssignedHighWater(opts *bind.TransactOpts, stakerAddr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Staking.contract.Transact(opts, "increaseAVAXAssignedHighWater", stakerAddr, amount)
}

// IncreaseAVAXAssignedHighWater is a paid mutator transaction binding the contract method 0xe4200b60.
//
// Solidity: function increaseAVAXAssignedHighWater(address stakerAddr, uint256 amount) returns()
func (_Staking *StakingSession) IncreaseAVAXAssignedHighWater(stakerAddr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Staking.Contract.IncreaseAVAXAssignedHighWater(&_Staking.TransactOpts, stakerAddr, amount)
}

// IncreaseAVAXAssignedHighWater is a paid mutator transaction binding the contract method 0xe4200b60.
//
// Solidity: function increaseAVAXAssignedHighWater(address stakerAddr, uint256 amount) returns()
func (_Staking *StakingTransactorSession) IncreaseAVAXAssignedHighWater(stakerAddr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Staking.Contract.IncreaseAVAXAssignedHighWater(&_Staking.TransactOpts, stakerAddr, amount)
}
...
//
// Solidity: function restakeGGP(address stakerAddr, uint256 amount) returns()
func (_Staking *StakingTransactor) RestakeGGP(opts *bind.TransactOpts, stakerAddr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Staking.contract.Transact(opts, "restakeGGP", stakerAddr, amount)
}

// RestakeGGP is a paid mutator transaction binding the contract method 0x4ce08478.
//
// Solidity: function restakeGGP(address stakerAddr, uint256 amount) returns()
func (_Staking *StakingSession) RestakeGGP(stakerAddr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Staking.Contract.RestakeGGP(&_Staking.TransactOpts, stakerAddr, amount)
}

// RestakeGGP is a paid mutator transaction binding the contract method 0x4ce08478.
//
// Solidity: function restakeGGP(address stakerAddr, uint256 amount) returns()
func (_Staking *StakingTransactorSession) RestakeGGP(stakerAddr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Staking.Contract.RestakeGGP(&_Staking.TransactOpts, stakerAddr, amount)
}

// SetLastRewardsCycleCompleted is a paid mutator transaction binding the contract method 0x9511ffc7.
//
// Solidity: function setLastRewardsCycleCompleted(address stakerAddr, uint256 cycleNumber) returns()
func (_Staking *StakingTransactor) SetLastRewardsCycleCompleted(opts *bind.TransactOpts, stakerAddr common.Address, cycleNumber *big.Int) (*types.Transaction, error) {
	return _Staking.contract.Transact(opts, "setLastRewardsCycleCompleted", stakerAddr, cycleNumber)
}

// SetLastRewardsCycleCompleted is a paid mutator transaction binding the contract method 0x9511ffc7.
//
// Solidity: function setLastRewardsCycleCompleted(address stakerAddr, uint256 cycleNumber) returns()
func (_Staking *StakingSession) SetLastRewardsCycleCompleted(stakerAddr common.Address, cycleNumber *big.Int) (*types.Transaction, error) {
	return _Staking.Contract.SetLastRewardsCycleCompleted(&_Staking.TransactOpts, stakerAddr, cycleNumber)
}

// SetLastRewardsCycleCompleted is a paid mutator transaction binding the contract method 0x9511ffc7.
//
// Solidity: function setLastRewardsCycleCompleted(address stakerAddr, uint256 cycleNumber) returns()
func (_Staking *StakingTransactorSession) SetLastRewardsCycleCompleted(stakerAddr common.Address, cycleNumber *big.Int) (*types.Transaction, error) {
	return _Staking.Contract.SetLastRewardsCycleCompleted(&_Staking.TransactOpts, stakerAddr, cycleNumber)
}
